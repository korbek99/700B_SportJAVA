 ...
 * @author Korbek
 */
@WebServlet(name = "InsertContenidos", urlPatterns = {"/InsertContenidos"})
public class InsertContenidos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql="Insert into pw03_contenido "
                    + "(PW03_TITULO,PW03_DESCRIPCION,PW03_IMG1,PW03_IMG2,PW03_STD,PW02_ID)"
                    + "values("
