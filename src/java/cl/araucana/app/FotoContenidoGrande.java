 ...
 * @author Korbek
 */
@WebServlet(name = "FotoContenidoGrande", urlPatterns = {"/FotoContenidoGrande"})
public class FotoContenidoGrande extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            + " WHERE  CO.PW02_ID=CA.PW02_ID and CO.PW03_ID="+request.getParameter("id")+""; // definer query
