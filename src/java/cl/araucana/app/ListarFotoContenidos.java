 ...
 * @author Korbek
 */
@WebServlet(name = "ListarFotoContenidos", urlPatterns = {"/ListarFotoContenidos"})
public class ListarFotoContenidos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            + " WHERE  CO.PW02_ID=CA.PW02_ID and CO.PW02_ID="+request.getParameter("id")+""; // definer query
