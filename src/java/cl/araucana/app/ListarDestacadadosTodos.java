 ...
 * @author Korbek
 */
@WebServlet(name = "ListarDestacadadosTodos", urlPatterns = {"/ListarDestacadadosTodos"})
public class ListarDestacadadosTodos extends HttpServlet {
