 ...
 * @author Korbek
 */
@WebServlet(name = "InsertDestacados", urlPatterns = {"/InsertDestacados"})
public class InsertDestacados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql="Insert into pw04_destacado "
                    + "(PW04_ID,PW03_ID,PW04_ORDEN)"
                    + "values("
                    + "" + request.getParameter("id") + ","
                    + "" + request.getParameter("iddescri") + ","
