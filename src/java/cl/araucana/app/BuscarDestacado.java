 ...
 * @author Korbek
 */
@WebServlet(name = "BuscarDestacado", urlPatterns = {"/BuscarDestacado"})
public class BuscarDestacado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            + "FROM pw04_destacado D ,pw03_contenido CO "
            + " WHERE  D.PW03_ID=CO.PW03_ID and D.PW04_ID="+request.getParameter("id") +"";
