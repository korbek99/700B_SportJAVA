 ...
 * @author jose.bustos
 */
@WebServlet(name = "ListarFotoDestacados", urlPatterns = {"/ListarFotoDestacados"})
public class ListarFotoDestacados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            {
                responseJson += "{";
                responseJson += "\"url\":\""+rs.getString("PW03_IMG1") +"\",";
               /*  responseJson += "\"iddescri\":\""+rs.getString("PW03_ID") +"\",";
                responseJson += "\"descripcion\":\""+rs.getString("PW03_DESCRIPCION") +"\",";
                responseJson += "\"orden\":\""+rs.getString("PW04_ORDEN") +"\"";*/
