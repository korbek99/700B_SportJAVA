 ...
 * @author Korbek
 */
@WebServlet(name = "ModificarDestacados", urlPatterns = {"/ModificarDestacados"})
public class ModificarDestacados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // definer query
            String sql="update pw04_destacado set "
                    + "PW03_ID="+request.getParameter("iddescri") +", "
                    + "PW04_ORDEN="+request.getParameter("orden") +" "                    
