 ...
 * @author Korbek
 */
@WebServlet(name = "EliminarContenido", urlPatterns = {"/EliminarContenido"})
public class EliminarContenido extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // definer query
            String sql="delete from pw03_contenido "
